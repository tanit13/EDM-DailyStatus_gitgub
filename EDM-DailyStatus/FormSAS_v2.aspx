<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormSAS_v2.aspx.cs" Inherits="EDM_DailyStatus.FormSAS_v2" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="css/css_edw.css" />
    ...
    <div class="container-fluid ">
        ...
        <form id="frmEDW" runat="server">
            ...
            <div class="row">
                ...
                <!-- display person production support team -->
                <div class="col-3">
                    <div class="widget widget-default widget-item-icon" onclick="#">
                        <div class="widget-item-left">
                        ...
                        <div class="widget-data">
                            <div runat="server" class="widget-int num-count">
                                <img width="100" height="35" class="media-object" src="pic/logo_sas.png" alt="Generic placeholder image">
                            </div>
            ...
            <div class="row">
                                            ...
                                            <div class="col-8">
                                                <h6>Timeline        
                                                    <div>
                                                        ...
                                                        <strong style="font-size: 12px; padding-right: 2px;">Complete</strong>
                                                    </div>
                                                </h6>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-5">
                                            <div class="progress-circle p40">
                                                <span style="margin-top: -10px; color: #1caf9a !important;">41
                                                    <h6 style="margin-top: -40px;">Conplete</h6>
                                                </span>
                                                <div class="left-half-clipper">
                                        ...
                                        <div class="col-5">
                                            <div class="progress-circle over50 p100">
                                                <span style="margin-top: -10px;">1300
                ...
                <style>
                    /*.progress-circle.over50 .first50-bar.text-red{
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-3 ">
                                            <h6 class="text-right">Monitor</h6>
                                        </div>
                                        <div class="col-6">
                                            <div class="progress">
                                    ...
                                    <div class="row">
                                        <div class="col-3 ">
                                            <h6 class="text-right">Running</h6>
                                        </div>
                                        <div class="col-6">
                                            <div class="progress">
                                    ...
                                    <div class="row">
                                        <div class="col-3 ">
                                            <h6 class="text-right">Complete</h6>
                                        </div>
                                        <div class="col-6">
                                            <div class="progress">
            ...
            <div class="row">
                ...
                <div class="col-8">
                    <div class="card rounded-0">
                        <div class="card card-body rounded-0">
                            <div id="barChart" style="width: 100%; height: 370px;"></div>
                        </div>
                    </div>
                </div>
