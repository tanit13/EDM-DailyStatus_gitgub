<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormEDW.aspx.cs" Inherits="EDM_DailyStatus.FormEDW" %>
...
<head runat="server">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#tbl_edw_all_status tbody').on('click', 'td .button_status', function () {
