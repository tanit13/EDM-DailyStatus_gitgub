<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormEDM_v1.aspx.cs" Inherits="EDM_DailyStatus.FormEDM_v1" %>
   ...
   to escape the outer clipping path.*/
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            lastupdate_clock_time();


        });

        function lastupdate_clock_time() {
            var now = new Date();
            var hour = now.getHours();
            var minutes = now.getMinutes();
            ...
            hour = hour < 10 ? '0' + hour : hour;
            minutes = minutes < 10 ? '0' + minutes : minutes;
            document.getElementById("lastupdate_time").innerText = hour + ":" + minutes;
            //$(".lastupdate_time").innerText(hour + ":" + minutes);
        }
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                type: "POST",
                url: "FormEDM_v1.aspx/getDataSummaryProject",
        ...
        function fadeTimelineT1() {
            ...
            //-- change data morris pie chart           
            updateMorrisPie(vaDashboardPie[1].Completed_percent);

            document.getElementById("h_total_on_pie").innerText = vaDashboardPie[1].Total_str;
            document.getElementById("b_total_job").innerText = vaDashboardPie[1].Total_str;
            document.getElementById("b_completed_job").innerText = vaDashboardPie[1].Completed_str;
        ...
        function fadeTimelineT2() {
            ...
            //-- change data morris pie chart           
            updateMorrisPie(vaDashboardPie[2].Completed_percent);

            document.getElementById("h_total_on_pie").innerText = vaDashboardPie[2].Total_str;
            document.getElementById("b_total_job").innerText = vaDashboardPie[2].Total_str;
            document.getElementById("b_completed_job").innerText = vaDashboardPie[2].Completed_str;
        ...
        function fadeTimelineT3(vaT) {
            ...
            //-- change data morris pie chart           
            updateMorrisPie(vaDashboardPie[0].Completed_percent);

            document.getElementById("h_total_on_pie").innerText = vaDashboardPie[0].Total_str;
            document.getElementById("b_total_job").innerText = vaDashboardPie[0].Total_str;
            document.getElementById("b_completed_job").innerText = vaDashboardPie[0].Completed_str;
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <h4 style="margin-top: 20px !important; font-weight: 400; font-size: 11px;" class="text-muted">version dashboard v.1.0.0</h4>
                                    <h4 style="margin-top: 10px !important; font-weight: 400; font-size: 11px;" class="text-muted">release june 2018 last update :
                                        <label id="lastupdate_time"></label>
                                    </h4>
                                </div>
                                    ...
                                    <div style="padding-left: 20px">
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 id="h_project_up" style="margin-top: 0 !important; font-weight: 400; color: #1ab394 !important; display: none">Ready</h5>
                                                    <h5 id="h_project_down" style="margin-top: 0 !important; font-weight: 400; color: #ed5565 !important; display: none">NotReady</h5>
                                                </td>
                                            </tr>
                                        </table>
                                        <div class="row">
            ...
            <div class="row">
                        ...
                        <div id="slide_timeline" class="carousel slide" data-ride="carousel" data-interval="20000">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    ...
                                    <!-- timeline FILE EXTRACTION -->
                                    <%--<div class='container-fluid' id="div_timeline_file_ext">
                                        <div class="row">
                                            <div class="col-6">
                                                <h5>Timeline
                                                    <div>
                                            ...
                                            <div class="col-6">
                                                <span class="badge badge-light pull-right" style="color: dimgrey; font-size: 25px;">FILE EXTRACTION</span>
                                            </div>
                                        </div>
                                        <ul class="htimeline">
                                            <li id="li_timeline6_file_ext" data-date='20:00 - 23:59' class='step col-sm-2 blue li_timeline6'>
                                                <table style="width: 100%; font-size: 12px;">
                                                    <asp:Literal ID="Literal1" runat="server"></asp:Literal>
                                                </table>
                                            </li>
                                            <li id="li_timeline1_file_ext" data-date='00:00 - 03:59' class='step col-sm-2 blue li_timeline1'>
                                                <table style="width: 100%; font-size: 12px;">
                                                    <asp:Literal ID="Literal2" runat="server"></asp:Literal>
                                                </table>
                                            </li>
                                            <li id="li_timeline2_file_ext" data-date='04:00 - 07:59' class='step col-sm-2 blue li_timeline2'>
                                                <table style="width: 100%; font-size: 12px;">
                                                    <asp:Literal ID="Literal3" runat="server"></asp:Literal>
                                                </table>
                                            </li>
                                            <li id="li_timeline3_file_ext" data-date='08:00 - 11:59' class='step col-sm-2 blue li_timeline3'>
                                                <table style="width: 100%; font-size: 12px;">
                                                    <asp:Literal ID="Literal4" runat="server"></asp:Literal>
                                                </table>
                                            </li>
                                            <li id="li_timeline4_file_ext" data-date='12:00 - 15:59' class='step col-sm-2 blue li_timeline4'>
                                                <table style="width: 100%; font-size: 12px;">
                                                    <asp:Literal ID="Literal5" runat="server"></asp:Literal>
                                                </table>
                                            </li>
                                            <li id="li_timeline5_file_ext" data-date='16:00 - 19:59' class='step col-sm-2 blue li_timeline5'>
                                                <table style="width: 100%; font-size: 12px;">
                                    ...
                                    <!-- timeline OUTBOUND -->
                                    <%--<div class='container-fluid' id="div_timeline_outbound">
                                        <div class="row">
                                            <div class="col-6">
                                                <h5>Timeline
                                                    <div>
                                            ...
                                            <div class="col-6">
                                                <span class="badge badge-light pull-right" style="color: dimgrey; font-size: 25px;">OUTBOUND</span>
                                            </div>
                                        </div>
                                        <ul class="htimeline">
                                            <li id="li_timeline6_outbound" data-date='20:00 - 23:59' class='step col-sm-2 blue li_timeline6'>
                                                <table style="width: 100%; font-size: 12px;">
                                                    <asp:Literal ID="Literal7" runat="server"></asp:Literal>
                                                </table>
                                            </li>
                                            <li id="li_timeline1_outbound" data-date='00:00 - 03:59' class='step col-sm-2 blue li_timeline1'>
                                                <table style="width: 100%; font-size: 12px;">
                                                    <asp:Literal ID="Literal8" runat="server"></asp:Literal>
                                                </table>
                                            </li>
                                            <li id="li_timeline2_outbound" data-date='04:00 - 07:59' class='step col-sm-2 blue li_timeline2'>
                                                <table style="width: 100%; font-size: 12px;">
                                                    <asp:Literal ID="Literal9" runat="server"></asp:Literal>
                                                </table>
                                            </li>
                                            <li id="li_timeline3_outbound" data-date='08:00 - 11:59' class='step col-sm-2 blue li_timeline3'>
                                                <table style="width: 100%; font-size: 12px;">
                                                    <asp:Literal ID="Literal10" runat="server"></asp:Literal>
                                                </table>
                                            </li>
                                            <li id="li_timeline4_outbound" data-date='12:00 - 15:59' class='step col-sm-2 blue li_timeline4'>
                                                <table style="width: 100%; font-size: 12px;">
                                                    <asp:Literal ID="Literal11" runat="server"></asp:Literal>
                                                </table>
                                            </li>
                                            <li id="li_timeline5_outbound" data-date='16:00 - 19:59' class='step col-sm-2 blue li_timeline5'>
                                                <table style="width: 100%; font-size: 12px;">
                ...
                <div class="col-md-4 col-lg-4 col-xl-4">
                    ...
                    <script>
                        ...
                        $(document).ready(function () {
                            vaDashboardPie = vaDashboardPieStr;

                            intMorrisPie('-');

                            $.ajax({
                                type: "POST",
                                url: "FormEDM_v1.aspx/getDataMorrisLineChart",
                                // data: '{"project":"' + project + '","tier":"' + tier + '","status":"' + status + '"}',
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                success: function (response) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "FormEDM_v1.aspx/getDataMorrisPie",
                                // data: '{"project":"' + project + '","tier":"' + tier + '","status":"' + status + '"}',
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                success: function (response) {
                                    var dataPieChart = JSON.parse(response.d);
                                    //alert('morris pie complete = ' + (100 - dataPieChart[0].Completed_percent));

                                    //vaDashboardPie = JSON.parse(vaDashboardPieStr);
                                    vaDashboardPie = dataPieChart;

                                    // console.log("-----" + vaDashboardPie[0].Completed)
                                    ...
                                    //   document.getElementById("b_completed_job").innerText = dataPieChart[0].Completed;
                        ...
                        function updateMorrisPie(vaComplete) {
                            objMorrisDonut.setData(
                                [
                                    { value: vaComplete, label: vaComplete + '%', formatted: 'Completed' },
                                    { value: 100 - vaComplete, label: (100 - vaComplete) + '%', formatted: '' }
                                ]
                            );
                            objMorrisDonut.select(0);
                        }
                    ...
                    <div class="card rounded-0">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-7 col-lg-7 col-xl-7">
                                    ...
                                    <div runat="server" id="div_pie_circle" class="" style="display: none">
                                        <span runat="server" id="span_pie_circle" style="font-size: 55px !important; margin-left: -65px; margin-top: -72px; color: #00A27A !important;">90</span>
                        ...
                        <span style="margin-top: -40px !important; padding: 5px 10px 10px 240px; font-size: 12px;" class="text-muted">Completed Job <b id="b_completed_job" runat="server">-</b> of <b id="b_total_job">-</b></span>
                    </div>
                </div>
            </div>
