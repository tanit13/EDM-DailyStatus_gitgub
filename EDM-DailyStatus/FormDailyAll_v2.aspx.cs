...
{
    public partial class FormDailyAll_v2 : System.Web.UI.Page
    {
        ...
        private string GetEDMGroup(string cycle)
        {
            ...
            try
            {
                ...
                for (int i = 0; dt.Rows.Count >= i; i++)
                {
                    ...
                    str_color = str_color == "btn btn-danger" ? str_color +" pulse-button_red " : str_color;

                    if (str_color == "btn btn-success")
                    {
                        str_btn_group += " <button type = 'button' class=' allobj  " + str_color + " btn-sm btn-custom mb-1 " + str_project + " '>" + str_group + "</button> \n ";
                    }
                    else
                    {
                        if (str_project == "proAll")
                        {
                            str_btn_group += " <button type = 'button' class=' allobj " + str_color + " btn-sm btn-custom mb-1 " + str_project + " notwork'>" + str_group + "</button> \n ";
                        }
                        else {
                            str_btn_group += " <button type = 'button' class=' allobj " + str_color + " btn-sm btn-custom mb-1 " + str_project + " '>" + str_group + "</button> \n ";
                        }                        
