<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormDailyAll_v2.aspx.cs" Inherits="EDM_DailyStatus.FormDailyAll_v2" %>
...
<head runat="server">
    ...
    <script>
        ...
        function StatusChange(project) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#h_num_completed').text(complete);
                    $('#h_num_running').text(running);
                    $('#h_num_failed').text(failed);
                    $('#h_num_notstart').text(notstart);
                    $('#h_num_total').text(total);

                    //$('#p_completed_p').text(Math.round(complete_p, -1) + '%');
                    //$('#p_running_p').text(Math.round(running_p, -1) + '%');
                    //$('#p_failed_p').text(Math.round(failed_p, -1) + '%');
                    //$('#p_notstarted_p').text(Math.round(notstart_p, -1) + '%');
                    //$('#p_total_p').text('100%');
        ...
        function getSumGroup() {
            //alert('in getSumGroup()');
            $.ajax({
                type: "POST",
                url: "streamAjax.aspx/getGroupSumAjax",
                data: '{"data":""}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
                    //    alert('getSumGroup() success')

                    var str_status = JSON.parse(response.d);
                    //   alert('getSum == ' + str_status.length);
                    // $('#tbl_group_sum').dataTable().fnAddData(str_status);
                },
                failure: function (response) {
                    alert('ajax failed');
                    alert(response.d);
                    ...
                    <div class="row">
                            ...
                            <div class="card bg-light border-0">
                                <div class="card-body">
                                    <div class="media align-items-stretch">
                                        <div class="p-3 text-center bg-primary-v2">
                                            <i class="fa fa-pause fa-3x text-white"></i>
                                        </div>
                                        <div style="padding-right: 15px;" class="p-3 bg-primary-gradient text-white media-body">
                                            <h5>Not Start</h5>
                                            <h5 id="h_num_notstart" class="mb-0">0</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6">
                            <div class="card bg-light border-0">
                                <div class="card-body">
                                    <div class="media align-items-stretch">
                                        <div class="p-3 text-center bg-danger-v2">
                                            <i class="fa fa-times-circle fa-3x text-white"></i>
                                        </div>
                                        <div class="p-3 bg-danger-gradient text-white media-body">
                                            <h5>Failed</h5>
                                            <h5 id="h_num_failed" class="mb-0">0</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
                            <div class="card bg-light border-0">
                                <div class="card-body">
                                    <div class="media align-items-stretch">
                                        <div class="p-3 text-center bg-warning-v2">
                                            <i class="fa fa-forward fa-3x text-white"></i>
                                        </div>
                                        <div class="p-3 bg-warning-gradient text-white media-body">
                                            <h5>Running</h5>
                                            <h5 id="h_num_running" class="mb-0">0</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
                            <div class="card bg-light border-0">
                                <div class="card-body">
                                    <div class="media align-items-stretch">
                                        <div class="p-3 text-center bg-success-v2">
                                            <i class="fa fa-check-circle fa-3x text-white"></i>
                                        </div>
                                        <div class="p-3 bg-success-gradient text-white media-body">
                                            <h5>Completed</h5>
                                            <h5 id="h_num_completed" class="mb-0">0</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header border-0 bg-white">
                                    <h5 class="text-muted">Todo List</h5>
                                </div>
                                <div class="card-body">



                                    <a href="#" class="media border-0 p-3">
                                        <div class="media-left pr-1">
                                            <div class="avatar avatar-md avatar-online">
                                                <img width="40" height="40" class="media-object rounded-circle" src="pic/avatar-s-7.png" alt="Generic placeholder image" />
                                                <span class="badge rounded-circle bg-warning-v2 align-bottom"></span>
                                            </div>
                                        </div>
                                        <div class="media-body w-100">
                                            <h6 class="list-group-item-heading text-muted">Roy Clark
                                            ...
                                            <p class="list-group-item-text mb-0">
                                                ...
                                                <span class="badge badge-danger ml-1">AF1</span>
                                                <span class="badge badge-info ml-1">GZUES</span>
                                            </p>
                                        </div>
                                    </a>
                                    <a href="#" class="media border-0 p-3">
                                        ...
                                        <div class="media-body w-100">
                                            ...
                                            <p class="list-group-item-text mb-0">
                                                ...
                                                <span class="badge badge-danger ml-1">AF1</span>
                                                <span class="badge badge-info ml-1">FRA</span>
                                            </p>
                                        </div>
                                    </a>
                                    <a href="#" class="media border-0 p-3">
